...
From the grid search, the best hyperparameters were found to be:
...
The model had the lowest loss with $C = 10$, and $\gamma = 0.1$, 4 logarithmically scaled values were used for each surrounding these values in the grid-search.

On the training model, the loss was $0$, and on the
